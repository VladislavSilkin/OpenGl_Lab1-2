...
void glScene::drawTriangles(){
    glBegin(GL_TRIANGLES);
    glColor4f(0.0f, 1.0f, 0.0f, 0.5f);         glVertex2d(-0.75, 0);
    glColor4f(0.0f, 1.0f, 0.0f, 0.5f);         glVertex2d(0.75, 0);
    glColor4f(0.0f, 1.0f, 0.0f, 1.0f);         glVertex2d(0, 0.75);
    glColor4f(0.0f, 1.0f, 0.0f, 1.0f);         glVertex2d(0, -0.75);
    glEnd();
}

void glScene::drawLines(){
    glBegin(GL_LINES);
    glColor4f(0.0f, 1.0f, 0.0f, 0.5f);         glVertex2d(-0.75, 0);
    glColor4f(0.0f, 1.0f, 0.0f, 0.5f);         glVertex2d(0.75, 0);
    glColor4f(0.0f, 1.0f, 0.0f, 1.0f);         glVertex2d(0, 0.75);
...
{  
    ...
    //glScissor(0, 0, 0, 0);
    //std::cout << "x = " << xLb << " y = " << yLb << " width = " << widthLb << " height = " << heightLb << "\n";
    glBlendFunc(sfactor, dfactor);
    std::cout << "paintGL: sfactor = " << sfactor << " dfactor = " << dfactor << "\n";
